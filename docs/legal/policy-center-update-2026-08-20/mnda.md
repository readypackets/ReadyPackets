...
This Mutual Non-Disclosure Agreement (the “Agreement”) is entered into as of this _____ day of ____________, 20___, by and between:

The ReadyPackets Group (“The Group”) and ________________________________________________ (“Client”).
...
“Confidential Information” includes, but is not limited to: business plans, logic maps, inventions, technical specifications, sketches, software, and any other proprietary data disclosed during the ReadyPacketsTM intake and production process.

## 3. Obligations of Confidentiality

Both parties agree to:

• Use the Confidential Information solely for the purpose of evaluating and creating the ReadyPacketsTM dossier.
...
## THE READYPACKETS GROUP

Signed: ______________________________

Name: ______________________________

Title: Lead Architect / Principal
