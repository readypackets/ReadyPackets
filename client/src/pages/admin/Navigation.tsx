...
const DEFAULT_ENTRIES: MenuEntry[] = [
  ...
  ["/admin/email-settings", "Email settings", "Email"], ["/admin/email-automations", "Email automations", "Email"], ["/admin/order-automations", "Order automations", "Email"], ["/admin/question-templates", "Phase 1 templates", "Email"],
